...
import 'package:fleet_flow/features/dashboard/presentation/view/command_center_view.dart';
import 'package:fleet_flow/features/fleet/presentation/view/vehicle_registry_view.dart';
import 'package:fleet_flow/features/trip/presentation/view/trip_dispatcher_view.dart';
import 'package:fleet_flow/features/fleet/presentation/view/maintenance_logs_view.dart';
import 'package:fleet_flow/features/expense/presentation/view/expense_fuel_view.dart';
import 'package:fleet_flow/features/driver/presentation/view/driver_profiles_view.dart';
import 'package:fleet_flow/features/analytics/presentation/view/analytics_reports_view.dart';
import 'package:fleet_flow/features/users/presentation/view/users_view.dart';
    ...
    return NavigationView(
      ...
      pane: NavigationPane(
        ...
        items: [
          ...
          if (auth.role == UserRole.fleetManager)
            PaneItem(
